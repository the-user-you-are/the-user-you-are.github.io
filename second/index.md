...
```html
<img style="float: left;" src="hill.jpg" width="auto" height="80px" alt="hill" title="hill" />
Lorem ipsum ...
```
...
```html
<img style="float: right;" src="hill.jpg" width="auto" height="80px" alt="hill" title="hill" />
Lorem ipsum ...
```
